...
def index():
    """
    This function creates an url to authorize in GitHub and redirect to the authorization url.
...
def documentation():
    """
    This is a function to render documentation.html with application documentation.
